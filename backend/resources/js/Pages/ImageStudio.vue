<template>
  <AppLayout>
    ...
    <div class="flex flex-col overflow-hidden" style="height: calc(100vh - 4.5rem)">
      <!-- Main area -->
...
import { useDropHandler }   from '@/composables/useFileDrop'
...
useDropHandler(files => processFiles(files, raw => store.add([raw])))
