...
use App\Domain\Workspaces\Application\UseCases\AcceptWorkspaceInvitationUseCase;
...
class AcceptWorkspaceInvitationController
{
    public function __construct(private readonly AcceptWorkspaceInvitationUseCase $useCase) {}
    ...
    public function __invoke(Request $request, string $token): JsonResponse
    {
        try {
            ...
            Log::error('workspaces.accept_invitation_unexpected', ['exception' => $e]);
